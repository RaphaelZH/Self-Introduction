...
\begin{document}
	...
	\begin{chapter}[images/Machine_Learning.jpg]{uicblue}{The start of learning data science}
	...
	\begin{frame}[fragile]{My offline learning practices (2)}
		\begin{figure}[!htb]
			...
			\endminipage\hfill
			\minipage{0.32\textwidth}
			\centering\includegraphics[width=\linewidth]{images/deep_learning_3.png}
			%\caption{A really Awesome Image}\label{fig:awesome_image1}
			\endminipage
		\end{figure}
		\vspace{-.4em}
